    ...
    <section className="py-20 px-4 sm:px-6 max-w-[1200px] mx-auto">
      ...
      >
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          ...
          <p className="text-base md:text-lg mb-10 text-zinc-400 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              ...
              className="group flex items-center justify-center gap-3 w-full sm:w-auto rounded-xl bg-gradient-to-b from-amber-400 to-amber-600 px-8 py-4 text-base font-bold text-zinc-950 shadow-xl transition-all hover:-translate-y-0.5 hover:shadow-amber-500/20 active:scale-95 font-display"
            >
